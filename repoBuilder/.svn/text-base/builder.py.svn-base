...
class Builder:
    ...
    def _init_builder(self, fs_repo_src):
        ...
        if sc_core_home:
            ...
            if os.name == "nt": 
                ...
                defines.SCS2TGF = check_file(os.path.join(bin, "scs2tgf"))
    ...
    def createMetaFiles(self, dir):
        ...
        print "Generate " + pathBin
        process = Popen(['-nc', '-', pathBin], executable=defines.SCS2TGF, stdin=PIPE, stdout=PIPE, stderr=PIPE)
