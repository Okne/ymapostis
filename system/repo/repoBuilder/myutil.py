...
from defines import PATH_REPO_BIN
from defines import PATH_REPO_SRC
...
def fileType(fileName, type):
	...
	#print fileName, type
	return fileName.lower().endswith("." + type.lower())
...
def convertToPathBin(pathSrc, type):
	...
	to		fs_repo/.../file
	"""
	lenRepoSrc = len(PATH_REPO_SRC) + 1
	lenType = len(type) + 1
	pathBin = PATH_REPO_BIN + "/" + pathSrc[lenRepoSrc:-lenType]
	return pathBin
